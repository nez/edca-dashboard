...
function searchbykeyword ( keyword, contracts, table ){

    var html = "<table class='table table-striped'>"+
        "<thead>"+
        "<tr>"+
        "<th>#</th><th style='width: 180px'>Contrato</th><th>Año</th><th>Producto o servicio</th><th>Monto (IVA)</th><th>Descarga</th>"+
        "</tr>"+
        "</thead>"+
        "<tbody>";
...
$('#buscar').keyup(function () {
    searchbykeyword($(this).val(), contracts, ctable);
});

$(document).ready(function(){
    searchbykeyword('', contracts, ctable);
});
