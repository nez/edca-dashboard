...
--
-- Name: currency; Type: TABLE; Schema: public; Owner: tester
--
...
ALTER TABLE currency OWNER TO tester;

--
-- Name: currency_id_seq; Type: SEQUENCE; Schema: public; Owner: tester
--
...
ALTER TABLE currency_id_seq OWNER TO tester;

--
-- Name: currency_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: tester
--
...
--
-- Name: documentformat; Type: TABLE; Schema: public; Owner: tester
--
...
ALTER TABLE documentformat OWNER TO tester;

--
-- Name: documentformat_id_seq; Type: SEQUENCE; Schema: public; Owner: tester
--

CREATE SEQUENCE documentformat_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE documentformat_id_seq OWNER TO tester;

--
-- Name: documentformat_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: tester
--

ALTER SEQUENCE documentformat_id_seq OWNED BY documentformat.id;


--
-- Name: documenttype; Type: TABLE; Schema: public; Owner: tester
--
...
ALTER TABLE documenttype OWNER TO tester;

--
-- Name: documenttype_id_seq; Type: SEQUENCE; Schema: public; Owner: tester
--
...
ALTER TABLE documenttype_id_seq OWNER TO tester;

--
-- Name: documenttype_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: tester
--
...
--
-- Name: language; Type: TABLE; Schema: public; Owner: tester
--
...
ALTER TABLE language OWNER TO tester;

--
-- Name: language_id_seq; Type: SEQUENCE; Schema: public; Owner: tester
--
...
ALTER TABLE language_id_seq OWNER TO tester;

--
-- Name: language_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: tester
--
...
SELECT pg_catalog.setval('award_id_seq', 226, true);
...
28	28	28	Presupuesto de Egresos de la Fedración 2015	46101	Transferencias a fideicomisos públicos	21677500.00	MXN	Nuevo Aeropuerto Internacional de la Ciudad de México	1409JZL0005	http://www.apartados.hacienda.gob.mx/presupuesto/temas/pef/2015/docs/09/r09_kdh_pie.pdf
...
102	102	102	Presupuesto de Egresos de la Federación 2015 y 2016	46101	Transferencias a fideicomisos públicos	2156884.20	MXN	Nuevo Aeropuerto Internacional de la Ciudad de México	1409JZL0005	http://www.apartados.hacienda.gob.mx/presupuesto/temas/pef/2015/docs/09/r09_kdh_pie.pdf
...
155	155	155			Servicios de protección, custodia, vigilancia y seguridad de sus bienes e intalaciones, así como el diseño e implementación de sistemas de seguridad y su supervisión permanente 	182500000.00	MXN	Nuevo Aeropuerto Internacional de la Ciudad de México	1409JZL0005	http://www.apartados.hacienda.gob.mx/presupuesto/temas/pef/2015/docs/09/r09_kdh_pie.pdf
162	162	162	Presupuesto de Egresos de la Fedración 2014, 2015,2016 y 2017	33301	Servicios de Informática	54998429.36	MXN	Nuevo Aeropuerto Internacional de la Ciudad de México		http://www.apartados.hacienda.gob.mx/presupuesto/temas/pef/2015/docs/09/r09_kdh_pie.pdf
\.
...
SELECT pg_catalog.setval('budget_id_seq', 226, true);
...
SELECT pg_catalog.setval('buyer_id_seq', 226, true);
...
28	28	SO-09KDH999-N26-2015	AD-SRO-DCAGI-SC-003/15	Plan de Maestro  para  el  Proyecto	Plan de Maestro  para  el  Proyecto	terminated	2015-03-02 00:00:00	2015-08-03 00:00:00	24630600.00	MXN	2015-03-02 00:00:00	\N	
...
141	141	IO-009KDH999-N82-2015	ITP-OP-DCAGl-SC-105/15 	Adecuación de espacios para las oficinas del Grupo Aeroportuario de la Ciudad de México (GACM) en el CEMCAS	Adecuación de espacios para las oficinas del Grupo Aeroportuario de la Ciudad de México (GACM) en el CEMCAS	terminated	2015-11-25 00:00:00	2015-12-31 00:00:00	8385420.04	MXN	2015-12-17 00:00:00	2016-04-29 00:00:00	Antecedente V del Convenio Modificatorio
...
SELECT pg_catalog.setval('contract_id_seq', 226, true);
...
2	145	\N	Convenio modificatorio al plazo: terminación 2019-05-01	El plazo de ejecución corresponde al periodo equivalente a 1612 días naturales contados a partir del día 1 de diciembre de 2014
3	145	\N	Convenio modificatorio al Monto $2'276,050,569.98	1841753116.00
4	53	\N	Primer Convenio Modificatorio de monto $364,993.50	300000
5	53	\N	Primer Convenio Modificatorio de plazo de ejecución tiempo de ejecución de los trabajo del 24-04- 2015 al 31-12- 2015.	plazo de ejecución tiempo de ejecución de los trabajo del 24-04- 2015 al 23-10-2015.
6	181	\N	Primer Convenio Modificatorio de monto $1,094,335.19	1221008.37
8	127	\N	Primer Convenio Modificatorio de monto $55,645.20 	46371.00
9	171	\N	Primer Convenio Modificatorio de monto $24,247,762.57	18726530.31
10	137	\N	Convenio Modificatorio por monto $1,554,000.00	1295000.00
11	137	\N	Convenio Modificatorio al plazo al 29 de febrero de 2016	2015-12-29
12	102	\N	Primer Convenio Modificatorio al monto $2´456,112.06	21156884.20
13	102	\N	Primer Convenio Modificatorio al plazo de ejecución 214 días naturales	plazo de ejecución 180 días naturales
14	95	\N	Segundo convenio modificatorio al monto $3,688,273.66	$3'286,659.95
15	95	\N	Segundo convenio modificatorio al plazo 14-05-2016	31-12-2015
16	59	\N	Convenio Modificatorio al monto $7´582,463.99	$6318719.99 
17	59	\N	Convenio modificatorio al plazo al 31 de marzo de 2016	29 de diciembre de 2015
18	60	\N	Convenio Modificatorio al monto $15'693,722.00	$13080028.00
19	60	\N	Convenio Modificatorio al plazo 31 de marzo de 2016	31 de diciembre de 2015
23	88	\N	Primer Convenio Modificatorio al monto $42´798,015.58	34245066.00
24	88	\N	Primer Convenio Modificatorio al plazo de ejecución a 223 días naturales, que iniciaron el 13-02-2015.	Plazo de ejecución de 180 días naturales, que iniciaron en 05-01-2015
26	104	\N	Convenio Modificatorio al monto $1´914,364.79	1595304.00
27	50	\N	Convenio Modificatorio al monto $8´784.086.85	7062582.40
28	141	\N	Convenio Modificatorio al monto $8´283,408.74	8385420.04
29	43	\N	Primer convenio modificatorio al monto $230,538,969.12 	157168157.92
30	43	\N	Primer convenio modificatorio al plazo 30-06-2016	31-12-2015
31	162	\N	Primer convenio modificatorio a las fechas de entregables a diciembre de 2016	31-12-2015
\.
...
SELECT pg_catalog.setval('contractamendmentchanges_id_seq', 31, true);
...
82	53	\N	Primer_Convenio_Modificatorio	Primer_Convenio_Modificatorio_ AD-AS-DCAGI-SC-019-BIS/2015	Primer Convenio Modificatorio de prestación de servicios profesionales	Servicios en el seguimiento, representación y defensa en juicio, presentes en materia laboral. 		2016-07-29 00:00:00	\N	PDF	ES
...
81	145	\N	Segundo Convenio Modificatorio	Segundo_Convenio_Modificatorio_al_contrato_AD/01CTO-MTO/2014	Segundo convenio modificatorio de monto y plazo 	Segundo Convenio modificatorio al contrato, por medio del cual se modifican en su totalidad las cláusulas Segunda, Tercera, Novena correspondientes a Monto del contrato, Plazo de ejecución, Responsabilidad y obligaciones a cargo de la Entidad		2016-07-29 00:00:00	\N	PDF	ES
...
83	181	\N	Primer Convenio Modificatorio	Primer Convenio Modificatorio al contrato AD-OP-DCAGI-SC-064/15	Primer Convenio Modificatorio a precios unitarios	Adecuación de espacios en el campamento existente en la puerta 8 del polígono del NAICM		2016-07-29 00:00:00	\N	PDF	ES
84	127	\N	Primer Convenio Modificatorio 	Primer Convenio Modificatorio al contrato AD-AS-DCAGI-SC-012/2014	Primer Convenio Modificatorio al contrato abierto de prestación de servicios para la realización de auditorías externas.	Servicios de Auditoría Externa que se realizarán sobre los estados financieros de la entidad con cifras al 31 de diciembre de 2014. 		2016-07-29 00:00:00	\N	PDF	ES
85	171	\N	Primer Convenio Modificatorio	Primer Convenio Modificatorio al contrato AD-SRO-DCAGI-SC-103/15	"Convenio adicional al monto del contrato plurianual, por medio del cual se modifica la cláusula Segunda, correspondiente al monto del contrato y forma de pago. Quedando de la siguiente forma: "	Estudios del Sistema de Drenaje Pluvial del Nuevo Aeropuerto Internacional de la Ciudad de México.		2016-07-29 00:00:00	2016-07-29 00:00:00	PDF	ES
86	137	\N	Convenio Modificatorio	Convenio modificatori al contrato ITP-AS-DCAGI-SC-017-15	Convenio Modificatori al contrato de prestación de servicio ITP-AS-DCAGI-SC-017-15	Obtención de la prestación del servicio integral de administración de personal y proceso de nomina, mediante un sistema especializado para recursos humanos y de nómina de gobierno.		2029-12-15 00:00:00	\N	PDF	ES
87	102	\N	Primer Convenio Modificatorio	Primer Convenio Modificatorio al contrato ITP-SRO-DCAGI-SC-016/15	Primer Convenio Modificatorio al contrato de servicios relacionado con obra pública número ITP-SRO-DCAGI-SC-016/15	Servicios de supervisión para la obra: extracción de ademes y restitución del terreno que ocupan dichos elementos ubicados en la poligonal para el Nuevo Aeropuerto Internacional de la Ciudad de México (NAICM)		2016-07-29 00:00:00	\N	PDF	ES
90	95	\N	Segundo convenio modificatorio	segundo convenio modificatorio ITP-SRO.DCAGI-SC-63/15	Segundo Convenio Adicional en monto y Plazo de ejecución de los servicios por medio del cual se modifican las cláusulas Segunda, y Tercera que reconoce la ampliación de los servicios	Supervisión para: la construcción del proyecto integral consistente en barda y camino perimetral, alumbrado, servicios inducidos y casetas de acceso para el Nuevo Aeropuerto Internacional de la Ciudad de México (primera etapa)		2016-07-29 00:00:00	\N	PDF	ES
91	59	\N	Primer Convenio Modificatorio	Primer Convenio Modificatorio al contrato ITP-AS-DCAGI-SC-058/15	Primer Convenio Modificatorio de prestación de servicios al contrato ITP-AS-DCAGI-SC-058/15	Servicio de asesoría técnica y capacitación a 800 trabajadores del programa empleo temporal de mano de obra campesina o urbana marginada para los 7 ejidos colindantes al predio del NAICM.		2015-12-29 00:00:00	\N	PDF	ES
92	60	\N	Primer Convenio Modificatorio	Primer Convenio Modificatorio ITP-AS-DCAGI-SC-060/15	Primer Convenio Modificatorio al contrato de prestación de servicios número para llevar a cabo el servicio "Plan de integración Ejidal del NAICM"	Lograr una compatibilidad sustentable de: bordes, usos de suelo, infraestructuras; entorno a la poligonal definitiva del Proyecto "Nuevo Aeropuerto Internacional de la Ciudad de México S.A. de C.V. y manejar los impactos locales de las obras asociadas al mismo, con acciones locales de mitigación. 		2015-12-29 00:00:00	\N	PDF	ES
93	139	\N	Primer convenio modificatorio al monto $20,640,000.00	Primer convenio modificatorio_ITP-AS-DCAGI-SC-036/15	Primer convenio modificatorio al contrato, por medio del cual se modifican las cláusulas primera y segunda, correspondientes al objeto del contrato y al monto del contrato	Servicios profesionales de consultoría, legales y/o normativos y acompañamiento en los procedimientos de contratación pública y elaboración de la memoria documental integral del desarrollo del  Nuevo Aeropuerto Internacional de la Ciudad de México		2016-07-29 00:00:00	\N	PDF	ES
94	88	\N	Primer_Convenio _Modificatorio	Primer_Convenio_Modificatorio_LPN-O-DCAGI-SC-014-2014	Primer Convenio Modificatorio al contrato de obra pública para la Extracción de ademes y restitución del terreno que ocupan dichos elementos ubicados en la poligonal para el Nuevo Aeropuerto Internacional de la Cuidad de México.	Extracción de ademes y restitución del terreno que ocupan dichos elementos ubicados en la poligonal para el Nuevo Aeropuerto Internacional de la Cuidad de México.		2016-07-29 00:00:00	\N	PDF	ES
97	104	\N	Convenio Modificatorio	Primer Convenio Modificatorio ITP-S-DCAGI-SC-009/2014	Convenio Modificatorio al contrato plurianual de arrendamiento de bienes muebles número ITP-S-DCAGI-SC-009/2014	Arrendamiento de Mobiliario Para Las Instalaciones De Torre Murano		2015-04-01 00:00:00	\N	PDF	ES
98	50	\N	Convenio Modificatorio	Primer Convenio Modificatorio ITP-SRO-DCAGI-SC-040/15	Primer Convenio Modificatorio al contrato de servicios relacionados a la obra pública número ITP-SRO-DCAGI-SC-040/15, para llevar a cabo los servicios de "Elaboración del Proyecto de Terracerías de los caminos provisionales para la construcción del NAICM.	Elaboración del proyecto de terracerías de los caminos provisionales para la construcción del Nuevo Aeropuerto Internacional de la Ciudad de México.		2015-12-01 00:00:00	\N	PDF	ES
99	141	\N	Convenio Modificatorio	Primer Convenio Modificatorio ITP-OP-DCAGl-SC-105/15 	Primer Convenio Modificatorio al contrato de obra pública a precios unitarios y tiempo determinado número ITP-OP-DCAGl-SC-105/15. 	Adecuación de espacios para las oficinas del Grupo Aeroportuario de la Ciudad de México (GACM) en el CEMCAS		2015-12-07 00:00:00	\N	PDF	ES
100	43	\N	Primer convenio modificatorio	Primer convenio modificatorio_GACM/DCI/SJ/CM-E/05-2015	Campaña de exploración Geotécnica de campo 2015. Muestreo y sistemas de Medición en el Subsuelo en las Zonas de Aeropistas, Calles de Rodaje y Caminos Internos del Nuevo Aeropuerto Internacional de la Ciudad de México (NAICM)	Campaña de exploración Geotécnica de campo 2015. Muestreo y sistemas de Medición en el Subsuelo en las Zonas de Aeropistas, Calles de Rodaje y Caminos Internos del Nuevo Aeropuerto Internacional de la Ciudad de México (NAICM)		2016-07-29 00:00:00	\N	PDF	ES
\.
...
SELECT pg_catalog.setval('contractdocuments_id_seq', 100, true);
...
SELECT pg_catalog.setval('contractingprocess_id_seq', 226, true);
...
--
-- Data for Name: currency; Type: TABLE DATA; Schema: public; Owner: tester
--

COPY currency (id, entity, currency, alphabetic_code, numeric_code, minor_unit) FROM stdin;
1	AFGHANISTAN	Afghani	AFN	971	2
2	ÅLAND ISLANDS	Euro	EUR	978	2
3	ALBANIA	Lek	ALL	008	2
4	ALGERIA	Algerian Dinar	DZD	012	2
...
11	ARGENTINA	Argentine Peso	ARS	032	2
12	ARMENIA	Armenian Dram	AMD	051	2
13	ARUBA	Aruban Florin	AWG	533	2
14	AUSTRALIA	Australian Dollar	AUD	036	2
15	AUSTRIA	Euro	EUR	978	2
16	AZERBAIJAN	Azerbaijanian Manat	AZN	944	2
17	BAHAMAS (THE)	Bahamian Dollar	BSD	044	2
18	BAHRAIN	Bahraini Dinar	BHD	048	3
19	BANGLADESH	Taka	BDT	050	2
20	BARBADOS	Barbados Dollar	BBD	052	2
...
114	INTERNATIONAL MONETARY FUND (IMF) 	SDR (Special Drawing Right)	XDR	960	N.A.
...
155	MEMBER COUNTRIES OF THE AFRICAN DEVELOPMENT BANK GROUP	ADB Unit of Account	XUA	965	N.A.
...
217	SISTEMA UNITARIO DE COMPENSACION REGIONAL DE PAGOS "SUCRE"	Sucre	XSU	994	N.A.
...
270	ZZ01_Bond Markets Unit European_EURCO	Bond Markets Unit European Composite Unit (EURCO)	XBA	955	N.A.
271	ZZ02_Bond Markets Unit European_EMU-6	Bond Markets Unit European Monetary Unit (E.M.U.-6)	XBB	956	N.A.
272	ZZ03_Bond Markets Unit European_EUA-9	Bond Markets Unit European Unit of Account 9 (E.U.A.-9)	XBC	957	N.A.
273	ZZ04_Bond Markets Unit European_EUA-17	Bond Markets Unit European Unit of Account 17 (E.U.A.-17)	XBD	958	N.A.
274	ZZ06_Testing_Code	Codes specifically reserved for testing purposes	XTS	963	N.A.
275	ZZ07_No_Currency	The codes assigned for transactions where no currency is involved	XXX	999	N.A.
276	ZZ08_Gold	Gold	XAU	959	N.A.
277	ZZ09_Palladium	Palladium	XPD	964	N.A.
278	ZZ10_Platinum	Platinum	XPT	962	N.A.
279	ZZ11_Silver	Silver	XAG	961	N.A.
\.


--
-- Name: currency_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tester
--

SELECT pg_catalog.setval('currency_id_seq', 279, true);


--
-- Data for Name: documentformat; Type: TABLE DATA; Schema: public; Owner: tester
--

COPY documentformat (id, category, name, template, reference) FROM stdin;
...
--
-- Name: documentformat_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tester
--

SELECT pg_catalog.setval('documentformat_id_seq', 1190, true);


--
-- Data for Name: documenttype; Type: TABLE DATA; Schema: public; Owner: tester
--

COPY documenttype (id, category, code, title, description, source) FROM stdin;
1	basic	tenderNotice	Tender Notice	The formal notice that gives details of a tender. This may be a link to a downloadable document, to a web page, or to an official gazette in which the notice is contained.	
2	basic	awardNotice	Award Notice	The formal notice that gives details of the contract award. This may be a link to a downloadable document, to a web page, or to an official gazette in which the notice is contained.	
3	basic	contractNotice	Contract Notice	The formal notice that gives details of a contract being signed and valid to start implementation. This may be a link to a downloadable document, to a web page, or to an official gazette in which the notice is contained.	
4	basic	completionCertificate	Completion certificate		
5	basic	procurementPlan	Procurement Plan		
6	basic	biddingDocuments	Bidding Documents	Information for potential suppliers, describing the goals of the contract (e.g. goods and services to be procured), and the bidding process.	
7	basic	technicalSpecifications	Technical Specifications	Detailed technical information about goods or services to be provided.	
8	basic	evaluationCriteria	Evaluation Criteria	Information about how bids will be evaluated.	
9	intermediate	evaluationReports	Evaluation report	Report on the evaluation of the bids and the application of the evaluation criteria, including the justification fo the award	
10	intermediate	contractSigned	Signed Contract		
11	intermediate	contractArrangements	Arrangements for ending contract		
12	intermediate	contractSchedule	Schedules and milestones		
13	intermediate	physicalProcessReport	Physical progress reports	A report on the status of implementation, usually against key milestones.	
14	intermediate	financialProgressReport	Financial progress reports	Dates and amounts of stage payments made (against total amount) and the source of those payments, including cost overruns, if any. Structured versions of this data can be provided through transactions.	
15	intermediate	finalAudit	Final Audit		
16	intermediate	hearingNotice	Public Hearing Notice	Details of any public hearings that took place as part of the planning for this procurement.	
17	intermediate	marketStudies	Market Studies		
18	intermediate	eligibilityCriteria	Eligibility Criteria	Detailed documents about the eligibility of bidders.	
19	intermediate	clarifications	Clarifications to bidders questions	Including replies to issues raised in pre-bid conferences.	
20	intermediate	shortlistedFirms	Shortlisted Firms		
21	advanced	environmentalImpact	Environmental Impact		
22	advanced	assetAndLiabilityAssessment	Assesment of government’s assets and liabilities		
23	advanced	riskProvisions	Provisions for management of risks and liabilities		
24	advanced	winningBid	Winning Bid		
25	advanced	complaints	Complaints and decisions		
26	advanced	contractAnnexe	Annexes to the Contract		
27	advanced	contractGuarantees	Guarantees		
28	advanced	subContract	Subcontracts	A document detailing subcontracts, the subcontract itself, or a linked OCDS document describing a subcontract.	
29	advanced	needsAssessment	Needs Assessment		
30	advanced	feasibilityStudy	Feasibility study		
31	advanced	projectPlan	Project plan		
32	advanced	billOfQuantity	Bill Of Quantity		
33	advanced	bidders	Information on bidders	Information on bidders or participants, their validation documents and any procedural exemptions for which they qualify	
34	advanced	conflictOfInterest	conflicts of interest uncovered		
35	advanced	debarments	debarments issued		
\.


--
-- Name: documenttype_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tester
--

SELECT pg_catalog.setval('documenttype_id_seq', 35, true);
...
SELECT pg_catalog.setval('implementation_id_seq', 226, true);
...
--
-- Data for Name: language; Type: TABLE DATA; Schema: public; Owner: tester
--

COPY language (id, alpha2, name) FROM stdin;
1	aa	Afar
2	ab	Abkhazian
3	ae	Avestan
4	af	Afrikaans
...
--
-- Name: language_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tester
--

SELECT pg_catalog.setval('language_id_seq', 184, true);
...
155	155	Artículo 1 de la LAASSP 
141	141	Artículo 43 de la LOPSRM.
182	182	
...
59	59	Artículo 41 fraccíon X, de la LAASSP
...
88	88	Artículo 27 fracción I LOPSRM
...
104	104	Artículo 43 de la LAASSP
...
SELECT pg_catalog.setval('planning_id_seq', 226, true);
...
SELECT pg_catalog.setval('procuringentity_id_seq', 226, true);
...
SELECT pg_catalog.setval('publisher_id_seq', 226, true);
...
SELECT pg_catalog.setval('tender_id_seq', 226, true);
