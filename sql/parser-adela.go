...
*/
    row := []string {"","\""+title+"\"",record[3],keywords,"18-jul-2016",contact,mbox,"","","","",
                     "\""+title+" en JSON\"",record[3],"http://cdn.datos.gob.mx/public/gacm/"+id+"/"+record[2],"json","","",""}
    w.Write(row)
    ...
    row = []string {"","\""+title+"\"",record[3],keywords,"18-jul-2016",contact,mbox,"","","","",
                     "\""+title+" en XLSX\"",record[3],"http://cdn.datos.gob.mx/public/gacm/"+id+"/"+id+".xlsx","xlsx","","",""}
    w.Write(row)

    row = []string {"","\""+title+"\"",record[3],keywords,"18-jul-2016",contact,mbox,"","","","",
                     "\""+title+" en PDF\"",record[3],"http://cdn.datos.gob.mx/public/gacm/"+id+"/"+id+".pdf","pdf","","",""}
     w.Write(row)
